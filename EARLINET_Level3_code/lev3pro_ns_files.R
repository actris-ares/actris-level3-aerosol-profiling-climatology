...
load("lev2db.Rda")
load("ProfilesNormalSeason355.Rda")
load("ProfilesNormalSeason532.Rda")
load("ProfilesNormalSeason1064.Rda")
load("System.Rda")
...
for (p in 1:33)
{
  db_355 = db_prof_ns_355[db_prof_ns_355$Station == loc2[p], c(2:27)]
  colnames(db_355)[3:26] = paste0(colnames(db_355)[3:26], "_355")
  
  db_532 = db_prof_ns_532[db_prof_ns_532$Station == loc2[p], c(2:27)]
  colnames(db_532)[3:26] = paste0(colnames(db_532)[3:26], "_532")
  
  db_1064 = db_prof_ns_1064[db_prof_ns_1064$Station == loc2[p], c(2:19)]
  ...
  altitude = ncdim_def(
    ...
    create_dimvar = TRUE,
    vals = altitude_data,
    longname = "Altitude of middle point of layer"
  )
  ...
  ns_file = nc_create(
    paste0(
      "ACTRIS_AerRemSen_",
      loc2[p],
      "_Lev03_NorSea_0019_Pro_v02_qc030.nc"
    ),
    variabili,
    force_v4 = TRUE
  )
  ...
  ncatt_put(ns_file, 0, attname = "title", attval = "Season average profile measurements - Normal")
  nc_close(ns_file)
  gw = getwd()
  file.rename(
    from = paste0(
