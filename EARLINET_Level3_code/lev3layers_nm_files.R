...
#db_int_layers[,14:27]=round(db_int_layers[,14:27],6)
...
lr_counts = array(NA, dim = c(12, 3, 20))
pd_counts = array(NA, dim = c(12, 3, 20))
...
time_bounds_data[, 1] = c(as.numeric(
  as.POSIXct("2000-01-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-01-31 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 2] = c(as.numeric(
  as.POSIXct("2000-02-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
...
time_bounds_data[, 3] = c(as.numeric(
  ...
  as.POSIXct("2019-03-31 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 4] = c(as.numeric(
  as.POSIXct("2000-04-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-04-30 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 5] = c(as.numeric(
  as.POSIXct("2000-05-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-05-31 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 6] = c(as.numeric(
  as.POSIXct("2000-06-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-06-30 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 7] = c(as.numeric(
  as.POSIXct("2000-07-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-07-31 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 8] = c(as.numeric(
  as.POSIXct("2000-08-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-08-31 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 9] = c(as.numeric(
  as.POSIXct("2000-09-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-09-30 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 10] = c(as.numeric(
  as.POSIXct("2000-10-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-10-31 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 11] = c(as.numeric(
  as.POSIXct("2000-11-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-11-30 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
time_bounds_data[, 12] = c(as.numeric(
  as.POSIXct("2000-12-01 00:00:00", tz = "GMT", origin = "1970-01-01 00:00:00")
), as.numeric(
  as.POSIXct("2019-12-31 23:59:59", tz = "GMT", origin = "1970-01-01 00:00:00")
))
...
for (p in 1:33)
{
  ...
  month_file = nc_create(
    paste0(
      "ACTRIS_AerRemSen_",
      loc2[p],
      "_Lev03_NorMon_0019_Lay_v02_qc030.nc"
    ),
    variabili,
    force_v4 = TRUE
  )
  ...
  ncatt_put(month_file, lidar_ratio_intervals, "description", descr)
  ...
  ncatt_put(month_file, 0, attname = "title", attval = "Monthly distribution of layer optical values - Normal")
  nc_close(month_file)
  gw = getwd()
  file.rename(
    from = paste0(
