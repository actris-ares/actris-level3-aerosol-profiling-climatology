...
load("lev2db.Rda")
load("Lev3Int_b_ns_355.Rda")
load("Lev3Int_e_ns_355.Rda")
load("Lev3Int_b_ns_532.Rda")
load("Lev3Int_e_ns_532.Rda")
load("Lev3Int_b_ns_1064.Rda")
load("Lev3Int_ang_ns.Rda")
load("System.Rda")
load("Lev3pbl_ns.Rda")
load("Lev3PartDep_ns_355.Rda")
load("Lev3PartDep_ns_532.Rda")
load("Lev3PartDep_ns_1064.Rda")
...
time_bounds_data[,1]=c(as.numeric(as.POSIXct("1999-12-01 00:00:00",tz="GMT",origin="1970-01-01 00:00:00")),as.numeric(as.POSIXct("2019-02-28 23:59:59",tz="GMT",origin="1970-01-01 00:00:00")))
time_bounds_data[,2]=c(as.numeric(as.POSIXct("2000-03-01 00:00:00",tz="GMT",origin="1970-01-01 00:00:00")),as.numeric(as.POSIXct("2019-05-31 23:59:59",tz="GMT",origin="1970-01-01 00:00:00")))
time_bounds_data[,3]=c(as.numeric(as.POSIXct("2000-06-01 00:00:00",tz="GMT",origin="1970-01-01 00:00:00")),as.numeric(as.POSIXct("2019-08-31 23:59:59",tz="GMT",origin="1970-01-01 00:00:00")))
time_bounds_data[,4]=c(as.numeric(as.POSIXct("2000-09-01 00:00:00",tz="GMT",origin="1970-01-01 00:00:00")),as.numeric(as.POSIXct("2019-11-30 23:59:59",tz="GMT",origin="1970-01-01 00:00:00")))
...
colnames(app) = c("Season", "Null")
for (s in sss)
{
  v = data.frame(s, NA)
  colnames(v) = c("Season", "Null")
  app = rbind(app, v)
}
app = app[-1, ]
...
for (p in 1:33)
{
  db_e355 = db_e_ns_355[db_e_ns_355$Station == loc2[p], ]
  db_e355 = merge(db_e355, app, by = "Season", all = TRUE)
  db_e532 = db_e_ns_532[db_e_ns_532$Station == loc2[p], ]
  db_e532 = merge(db_e532, app, by = "Season", all = TRUE)
  db_b355 = db_b_ns_355[db_b_ns_355$Station == loc2[p], ]
  db_b355 = merge(db_b355, app, by = "Season", all = TRUE)
  db_b532 = db_b_ns_532[db_b_ns_532$Station == loc2[p], ]
  db_b532 = merge(db_b532, app, by = "Season", all = TRUE)
  db_b1064 = db_b_ns_1064[db_b_ns_1064$Station == loc2[p], ]
  db_b1064 = merge(db_b1064, app, by = "Season", all = TRUE)
  db_pbl = db_pbl_ns_tot[db_pbl_ns_tot$Station == loc2[p], ]
  db_pbl = merge(db_pbl, app, by = "Season", all = TRUE)
  db_pd355 = db_pd_ns_355[db_pd_ns_355$Station == loc2[p], ]
  db_pd355 = merge(db_pd355, app, by = "Season", all = TRUE)
  db_pd532 = db_pd_ns_532[db_pd_ns_532$Station == loc2[p], ]
  db_pd532 = merge(db_pd532, app, by = "Season", all = TRUE)
  db_pd1064 = db_pd_ns_1064[db_pd_ns_1064$Station == loc2[p], ]
  db_pd1064 = merge(db_pd1064, app, by = "Season", all = TRUE)
  db_ang = db_ang_ns_tot[db_ang_ns_tot$Station == loc2[p], ]
  db_ang = merge(db_ang, app, by = "Season", all = TRUE)
  ...
  val_time = c(
    as.numeric(as.POSIXct(
      paste0("2000-01-15 23:59:59"),
      tz = "GMT",
      origin = "1970-01-01 00:00:00"
    )),
    as.numeric(as.POSIXct(
      paste0("2000-04-15 23:59:59"),
      tz = "GMT",
      origin = "1970-01-01 00:00:00"
    )),
    as.numeric(as.POSIXct(
      paste0("2000-07-15 23:59:59"),
      tz = "GMT",
      origin = "1970-01-01 00:00:00"
    )),
    as.numeric(as.POSIXct(
      paste0("2000-10-15 23:59:59"),
      tz = "GMT",
      origin = "1970-01-01 00:00:00"
    ))
  )
  ...
  season_file = nc_create(
    paste0(
      "ACTRIS_AerRemSen_",
      loc2[p],
      "_Lev03_NorSea_0019_Int_v02_qc030.nc"
    ),
    variabili,
    force_v4 = TRUE
  )
  ...
  ncatt_put(season_file, 0, attname = "title", attval = "Seasonal average integrated measurements - Normal")
