...
db_e = db_int_e[db_int_e$Wavelength == "0355", ]
db_b = db_int_b[db_int_b$Wavelength == "0355", ]
...
db_e_m_cnt = aggregate(db_e_m[4:16],
                       by = list(db_e_m$Station, db_e_m$Year, db_e_m$Month),
                       FUN = cnt)
db_b_m_cnt = aggregate(db_b_m[4:16],
                       by = list(db_b_m$Station, db_b_m$Year, db_b_m$Month),
                       FUN = cnt)
...
save(db_b_y_355, file = "Lev3Int_b_y_355.Rda")
save(db_e_y_355, file = "Lev3Int_e_y_355.Rda")
...
save(db_b_s_355, file = "Lev3Int_b_s_355.Rda")
save(db_e_s_355, file = "Lev3Int_e_s_355.Rda")
...
save(db_b_nm_355, file = "Lev3Int_b_nm_355.Rda")
save(db_e_nm_355, file = "Lev3Int_e_nm_355.Rda")
...
wgs_e = aggregate(db_e_s_cnt[3:15],
                  by = list(db_e_s_cnt$Station, db_e_s_cnt$Season),
                  FUN = ws)
wgs_b = aggregate(db_b_s_cnt[3:15],
...
save(db_b_ns_355, file = "Lev3Int_b_ns_355.Rda")
save(db_e_ns_355, file = "Lev3Int_e_ns_355.Rda")
...
nms = c("Station", "Year", "Month")
colnames(db_pbl_m_mean)[1:3] = nms
...
colnames(db_pbl_m_cnt)[1:3] = nms
db_pbl_m_cnt = db_pbl_m_cnt[order(db_pbl_m_cnt$Station, db_pbl_m_cnt$Year, db_pbl_m_cnt$Month), ]
...
colnames(db_pbl_y_mean)[1:2] = nms1
...
db_pbl_y_median = data.frame(matrix(NA, nrow = nrow(db_pbl_y_c), ncol =
                                      3))
colnames(db_pbl_y_median) = colnames(db_pbl_y_c)
db_pbl_y_median[, 1:2] = db_pbl_y_c[, 1:2]

db_pbl_y_median[, 3] = mapply(w_median, db_pbl_y_c[, 3], wgs_pbl[, 3])
...
db_pbl_y_sd[, 3] = mapply(w_sd, db_pbl_y_c[, 3], wgs_pbl[, 3])

db_pbl_y_cnt = aggregate(db_pbl_m[4],
                         by = list(db_pbl_m$Station, db_pbl_m$Year),
                         FUN = cnt)

colnames(db_pbl_y_cnt)[1:2] = nms1
...
db_pbl_y_tot = cbind(db_pbl_y_mean, db_pbl_y_median[3], db_pbl_y_sd[3], db_pbl_y_cnt[3])

save(db_pbl_y_tot, file = "Lev3pbl_y.Rda")
...
db_pbl_s_cnt = aggregate(db_pbl_s[3],
                         by = list(db_pbl_s$Station, db_pbl_s$Season_Year),
                         FUN = cnt)
colnames(db_pbl_s_cnt)[1:2] = c("Station", "Season_Year")
db_pbl_s_cnt = db_pbl_s_cnt[order(db_pbl_s_cnt$Station,
...
db_pbl_s_tot = cbind(db_pbl_s_mean, db_pbl_s_median[3], db_pbl_s_sd[3], db_pbl_s_cnt[3])

save(db_pbl_s_tot, file = "Lev3pbl_s.Rda")
...
colnames(db_pbl_nm_mean)[1:2] = nms2
...
db_pbl_nm_median = data.frame(matrix(NA, nrow = nrow(db_pbl_nm_c), ncol =
                                       3))
colnames(db_pbl_nm_median) = colnames(db_pbl_nm_c)
db_pbl_nm_median[, 1:2] = db_pbl_nm_c[, 1:2]

db_pbl_nm_median[, 3] = mapply(w_median, db_pbl_nm_c[, 3], wgs_pbl[, 3])
...
db_pbl_nm_sd[, 3] = mapply(w_sd, db_pbl_nm_c[, 3], wgs_pbl[, 3])

db_pbl_nm_cnt = aggregate(db_pbl_m[4],
                          by = list(db_pbl_m$Station, db_pbl_m$Month),
                          FUN = cnt)

colnames(db_pbl_nm_cnt)[1:2] = nms2
...
save(db_pbl_nm_tot, file = "Lev3pbl_nm.Rda")
...
colnames(db_pbl_ns_mean)[1:2] = nms3
...
db_pbl_ns_median = data.frame(matrix(NA, nrow = nrow(db_pbl_ns_c), ncol =
                                       3))
colnames(db_pbl_ns_median) = colnames(db_pbl_ns_c)
db_pbl_ns_median[, 1:2] = db_pbl_ns_c[, 1:2]

db_pbl_ns_median[, 3] = mapply(w_median, db_pbl_ns_c[, 3], wgs_pbl[, 3])
...
db_pbl_ns_sd[, 3] = mapply(w_sd, db_pbl_ns_c[, 3], wgs_pbl[, 3])

db_pbl_ns_cnt = aggregate(db_pbl_ns[3],
                          by = list(db_pbl_ns$Station, db_pbl_ns$Season),
                          FUN = cnt)

colnames(db_pbl_ns_cnt)[1:2] = nms3
...
save(db_pbl_ns_tot, file = "Lev3pbl_ns.Rda")

#----PartDep_355----

load("Lev3PartDep.Rda")

db_pd = db_pd[db_pd$Wavelength == "0355", ]
...
save(db_pd_y_355, file = "Lev3PartDep_y_355.Rda")
...
db_pd_s_mean = db_pd_s_mean[order(db_pd_s_mean$Station,
...
save(db_pd_s_355, file = "Lev3PartDep_s_355.Rda")
...
db_pd_nm_median = data.frame(matrix(NA, nrow = nrow(db_pd_nm_c), ncol =
                                      8))
...
db_pd_nm_355 = cbind(db_pd_nm_mean, db_pd_nm_median[3:8], db_pd_nm_sd[3:8], db_pd_nm_cnt[3:8])

save(db_pd_nm_355, file = "Lev3PartDep_nm_355.Rda")
...
db_pd_ns_median = data.frame(matrix(NA, nrow = nrow(db_pd_ns_c), ncol =
                                      8))
...
db_pd_ns_355 = cbind(db_pd_ns_mean, db_pd_ns_median[3:8], db_pd_ns_sd[3:8], db_pd_ns_cnt[3:8])

save(db_pd_ns_355, file = "Lev3PartDep_ns_355.Rda")
